...
class funcs():
    ...
    def Variaveis(self):  # essa função variaveis evita está repetido as variaveis em outras funções
    ...
    def select_lista(self):
        ...
        """)  # o select classifica em ordem alfabetica(asc)
        for i in lista:
...
class Application(funcs):
    ...
    def criando_botoes(self):
        ...
        # Criação da label entrada de telefone
    ...
    def lista_frame2(self):
        ...
        # criando a função para chamar o OnClick
        self.listaCli.bind("<Double-1>",
                           self.OnDoubleClik)  # usamos bind toda vez que precisamos fazer interação com a lista
        # Double serve para toda vez que damos os dois clicks
